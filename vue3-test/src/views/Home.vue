<template>
  <div>
    <header class="home-header wrap" :class="{'active':headerScroll}">
        ...
        <router-link tag="span" class="login" to="./login" v-if="!isLogin">登录</router-link>
      ...
      <van-skeleton title :row="3" :loading="loading">
        <div class="good-box">
          <div class="good-item" v-for="item in recommends" :key="item.goodsId" @click="goToDEtail(item)">
            ...
            <div class="good-desc">
              <div class="title">{{item.goodsName}}</div>
              <div class="price">￥{{item.ssellingPrice}}</div>
            </div>
          </div>
          </div>
      </van-skeleton>
...
import {getLocal} from "../components/js/utils"
